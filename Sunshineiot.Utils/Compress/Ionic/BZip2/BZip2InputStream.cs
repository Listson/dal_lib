...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:Sunshineiot.Utils.Ionic.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace Sunshineiot.Utils.Ionic.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly Sunshineiot.Utils.Ionic.Crc.CRC32 crc = new Sunshineiot.Utils.Ionic.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new Sunshineiot.Utils.Ionic.BZip2.BZip2InputStream(fs))
        ///       {
