...
namespace Sunshineiot.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public Sunshineiot.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "Sunshineiot.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "Sunshineiot.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "Sunshineiot.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace Sunshineiot.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the Sunshineiot.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  Sunshineiot.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("Sunshineiot.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the Sunshineiot.Utils.Ionic.Zip
                        ...
                        // add the Sunshineiot.Utils.Ionic.Utils.Zip DLL as an embedded resource
