...
// reading zip files.  This class does not depend on Sunshineiot.Utils.Ionic.Zip.ZipFile, but rather
    ...
    public class ZipInputStream : Stream
    {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                Sunshineiot.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private Sunshineiot.Utils.Ionic.Crc.CrcCalculatorStream _crcStream;
