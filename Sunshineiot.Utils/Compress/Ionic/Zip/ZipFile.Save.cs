...
namespace Sunshineiot.Utils.Ionic.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="Sunshineiot.Utils.Ionic.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new Sunshineiot.Utils.Ionic.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= Sunshineiot.Utils.Ionic.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = Sunshineiot.Utils.Ionic.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = Sunshineiot.Utils.Ionic.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
