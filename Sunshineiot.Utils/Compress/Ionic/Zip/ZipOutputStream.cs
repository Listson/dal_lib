...
// generating zip files.  This class does not depend on Sunshineiot.Utils.Ionic.Zip.ZipFile, but rather
...
using System.IO;
using Sunshineiot.Utils.Ionic.Zip;
...
namespace Sunshineiot.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = Sunshineiot.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="Sunshineiot.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = Sunshineiot.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="Sunshineiot.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private Sunshineiot.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public Sunshineiot.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
