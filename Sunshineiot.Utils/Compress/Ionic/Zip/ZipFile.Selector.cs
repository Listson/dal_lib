...
namespace Sunshineiot.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Sunshineiot.Utils.Ionic.FileSelector ff = new Sunshineiot.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace Sunshineiot.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(Sunshineiot.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Sunshineiot.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Sunshineiot.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Sunshineiot.Utils.Ionic.Zip.ZipEntry> SelectEntries(Sunshineiot.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Sunshineiot.Utils.Ionic.Zip.ZipEntry>();

            foreach (Sunshineiot.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Sunshineiot.Utils.Ionic.Zip.ZipEntry> SelectEntries(Sunshineiot.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
