...
namespace Sunshineiot.Utils.Ionic
{
    ...
    ///   cref="Sunshineiot.Utils.Ionic.Zip.ZipFile.AddSelectedFiles(String,String)"/> method, or one of
    ///   its overloads, is called.  It's also used for the <see
    ///   cref="Sunshineiot.Utils.Ionic.Zip.ZipFile.ExtractSelectedEntries(String)"/> methods.  Typically, an
