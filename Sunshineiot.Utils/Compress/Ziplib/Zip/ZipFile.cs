...
using Sunshineiot.Utils.ZipLib.Encryption;
#endif

using Sunshineiot.Utils.ZipLib.Core;
using Sunshineiot.Utils.ZipLib.Checksums;
using Sunshineiot.Utils.ZipLib.Zip.Compression.Streams;
using Sunshineiot.Utils.ZipLib.Zip.Compression;

namespace Sunshineiot.Utils.ZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using Sunshineiot.Utils.ZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Sunshineiot.Utils.ZipLib.Zip.ZipException">
