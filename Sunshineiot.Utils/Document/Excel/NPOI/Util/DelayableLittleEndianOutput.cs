...
namespace Sunshineiot.Utils.NPOI.Util
{
    using System;
    ...
    /// the header has been written.  The client code can call <see cref="M:Sunshineiot.Utils.NPOI.Util.IDelayableLittleEndianOutput.CreateDelayedOutput"/>
