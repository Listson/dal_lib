...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:Sunshineiot.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, Sunshineiot.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
