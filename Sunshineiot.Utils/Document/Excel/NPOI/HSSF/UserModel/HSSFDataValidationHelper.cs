...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFDataValidationHelper : IDataValidationHelper
    {
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateDateConstraint
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateExplicitListConstraint
         * (java.lang.String[])
         */
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateFormulaListConstraint
         * (java.lang.String)
         */
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateNumericConstraint
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTextLengthConstraint
         * (int, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTimeConstraint
         * (int, java.lang.String, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * Sunshineiot.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateValidation(org
         * .apache.poi.SS.UserModel.DataValidationConstraint,
         * Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddressList)
         */
