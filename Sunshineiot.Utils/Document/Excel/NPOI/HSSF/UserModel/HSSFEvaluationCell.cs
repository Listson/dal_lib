...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private Sunshineiot.Utils.NPOI.SS.UserModel.ICell _cell;

        public HSSFEvaluationCell(Sunshineiot.Utils.NPOI.SS.UserModel.ICell cell, IEvaluationSheet evalSheet)
        {
            _cell = cell;
            _evalSheet = evalSheet;
        }
        public HSSFEvaluationCell(Sunshineiot.Utils.NPOI.SS.UserModel.ICell cell)
        {
            _cell = cell;
        ...
        {
            Sunshineiot.Utils.NPOI.SS.UserModel.ICell cellb = ((HSSFEvaluationCell)obj)._cell;
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
