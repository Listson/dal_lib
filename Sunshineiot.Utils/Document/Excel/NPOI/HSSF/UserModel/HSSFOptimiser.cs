...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFOptimiser
    {
        ...
        public static void OptimiseFonts(HSSFWorkbook workbook)
        {
            ...
            {
                Sunshineiot.Utils.NPOI.SS.UserModel.ISheet s = workbook.GetSheetAt(sheetNum);
                ...
                while (rIt.MoveNext())
                {
                    ...
                    while (cIt.MoveNext())
                    {
                        ...
                        if (cell.CellType == Sunshineiot.Utils.NPOI.SS.UserModel.CellType.STRING)
                        {
            ...
            for (int sheetNum = 0; sheetNum < workbook.NumberOfSheets; sheetNum++)
            {
                ...
                while (rIt.MoveNext())
                {
                    ...
                    while (cIt.MoveNext())
                    {
                        ...
                        Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle newStyle = workbook.GetCellStyleAt(
                                newPos[oldXf]
                        );
