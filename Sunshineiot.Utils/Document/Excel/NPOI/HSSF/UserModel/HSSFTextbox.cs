...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    [Serializable]
    public class HSSFTextbox : HSSFSimpleShape //,Sunshineiot.Utils.NPOI.SS.UserModel.ITextbox
    {
    ...
    public static short  VERTICAL_ALIGNMENT_DISTRIBUTED= 7;
        ...
        Sunshineiot.Utils.NPOI.SS.UserModel.IRichTextString str = new HSSFRichTextString("");
        ...
        public virtual Sunshineiot.Utils.NPOI.SS.UserModel.IRichTextString String
        {
            get { return str; }
            set
