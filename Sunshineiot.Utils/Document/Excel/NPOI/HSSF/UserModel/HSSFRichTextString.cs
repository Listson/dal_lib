...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,Sunshineiot.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, Sunshineiot.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(Sunshineiot.Utils.NPOI.SS.UserModel.IFont font)
        {
