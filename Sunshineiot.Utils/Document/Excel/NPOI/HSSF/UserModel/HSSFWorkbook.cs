...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    using Sunshineiot.Utils.NPOI.POIFS.FileSystem;
    using Sunshineiot.Utils.NPOI.SS.Formula;
    using Sunshineiot.Utils.NPOI.SS.Formula.PTG;
    using Sunshineiot.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : Sunshineiot.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private Sunshineiot.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = Sunshineiot.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            Sunshineiot.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public Sunshineiot.Utils.NPOI.SS.UserModel.Font FindFont(Sunshineiot.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 Sunshineiot.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, Sunshineiot.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public Sunshineiot.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                Sunshineiot.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public Sunshineiot.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, Sunshineiot.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case Sunshineiot.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case Sunshineiot.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case Sunshineiot.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case Sunshineiot.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case Sunshineiot.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case Sunshineiot.Utils.NPOI.SS.UserModel.PictureType.DIB:
