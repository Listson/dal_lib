...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.Windows.Forms;
    using Sunshineiot.Utils.NPOI.DDF;
    using Sunshineiot.Utils.NPOI.HSSF.Model;
    using Sunshineiot.Utils.NPOI.HSSF.Record;
    using Sunshineiot.Utils.NPOI.HSSF.Record.Aggregates;
    using Sunshineiot.Utils.NPOI.HSSF.Record.AutoFilter;
    using Sunshineiot.Utils.NPOI.HSSF.Util;
    using Sunshineiot.Utils.NPOI.SS;
    using Sunshineiot.Utils.NPOI.SS.Formula;
    using Sunshineiot.Utils.NPOI.SS.Formula.PTG;
    using Sunshineiot.Utils.NPOI.SS.UserModel;
    using Sunshineiot.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : Sunshineiot.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, Sunshineiot.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="Sunshineiot.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, Sunshineiot.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="Sunshineiot.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(Sunshineiot.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            Sunshineiot.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(Sunshineiot.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public Sunshineiot.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new Sunshineiot.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="Sunshineiot.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddress region = (Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(Sunshineiot.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    Sunshineiot.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, Sunshineiot.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Sunshineiot.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(Sunshineiot.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(Sunshineiot.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public Sunshineiot.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                Sunshineiot.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public Sunshineiot.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                Sunshineiot.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
