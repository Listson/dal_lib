...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationWorkbook : IFormulaRenderingWorkbook, IEvaluationWorkbook, IFormulaParsingWorkbook
    {
        ...
        private Sunshineiot.Utils.NPOI.HSSF.Model.InternalWorkbook _iBook;

        public static HSSFEvaluationWorkbook Create(Sunshineiot.Utils.NPOI.SS.UserModel.IWorkbook book)
        {
            if (book == null)
            {
                return null;
