...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
    ...
    using Sunshineiot.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)Sunshineiot.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)Sunshineiot.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
