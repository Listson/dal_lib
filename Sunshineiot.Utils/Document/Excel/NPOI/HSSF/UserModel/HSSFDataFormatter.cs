...
namespace Sunshineiot.Utils.NPOI.HSSF.UserModel
{
     ...
     * codes, etc.
     * 
     * Internally, formats will be implemented using subclasses of <see cref="Sunshineiot.Utils.NPOI.SS.Util.FormatBase"/>
     * such as <see cref="Sunshineiot.Utils.NPOI.SS.Util.DecimalFormat"/> and <see cref="Sunshineiot.Utils.NPOI.SS.Util.SimpleDateFormat"/>. Therefore the
