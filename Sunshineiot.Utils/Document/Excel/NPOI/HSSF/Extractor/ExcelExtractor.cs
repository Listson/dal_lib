...
namespace Sunshineiot.Utils.NPOI.HSSF.Extractor
{
    ...
    public class ExcelExtractor : POIOLE2TextExtractor
    {
                    ...
                    for (int j = firstRow; j <= lastRow; j++)
                    {
                        ...
                        for (int k = firstCell; k < lastCell; k++)
                        {
                            ...
                            else
                            {
                                ...
                                Sunshineiot.Utils.NPOI.SS.UserModel.IComment comment = cell.CellComment;
        ...
        /// <returns></returns>
        private String ExtractHeaderFooter(Sunshineiot.Utils.NPOI.SS.UserModel.IHeaderFooter hf)
        {
            StringBuilder text = new StringBuilder();
