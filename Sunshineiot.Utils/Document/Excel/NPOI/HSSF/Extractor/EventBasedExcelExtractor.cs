...
namespace Sunshineiot.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    using Sunshineiot.Utils.NPOI;
    using Sunshineiot.Utils.NPOI.HPSF;
    using Sunshineiot.Utils.NPOI.SS.Formula.Eval;
    using Sunshineiot.Utils.NPOI.HSSF.EventUserModel;
    ...
    public class EventBasedExcelExtractor : POIOLE2TextExtractor
    {
        ...
        private class TextListener : HSSFListener
        {
            ...
            private String FormatNumberDateCell(CellValueRecordInterface cell, double value)
            {
                ...
                {
                    // Is it a date?
                    if (Sunshineiot.Utils.NPOI.SS.UserModel.DateUtil.IsADateFormat(formatIndex, formatString) &&
                            Sunshineiot.Utils.NPOI.SS.UserModel.DateUtil.IsValidExcelDate(value))
                    {
                        ...
                        // Format as a date
                        DateTime d = Sunshineiot.Utils.NPOI.SS.UserModel.DateUtil.GetJavaDate(value, false);
