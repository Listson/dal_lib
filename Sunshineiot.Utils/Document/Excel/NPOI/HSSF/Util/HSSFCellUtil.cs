...
namespace Sunshineiot.Utils.NPOI.HSSF.Util
{
    using System;
    using System.Collections;
    using Sunshineiot.Utils.NPOI.HSSF.UserModel;
    ...
    public class HSSFCellUtil
    {
        ...
        public static Sunshineiot.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            Sunshineiot.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
        ...
        public static Sunshineiot.Utils.NPOI.SS.UserModel.ICell GetCell(Sunshineiot.Utils.NPOI.SS.UserModel.IRow row, int column)
        {
            Sunshineiot.Utils.NPOI.SS.UserModel.ICell cell = row.GetCell(column);
        ...
        public static Sunshineiot.Utils.NPOI.SS.UserModel.ICell CreateCell(Sunshineiot.Utils.NPOI.SS.UserModel.IRow row, int column, String value, HSSFCellStyle style)
        {
            Sunshineiot.Utils.NPOI.SS.UserModel.ICell cell = GetCell(row, column);
        ...
        /// <param name="value">The value of the cell</param>
        /// <returns>A new HSSFCell.</returns>
        public static Sunshineiot.Utils.NPOI.SS.UserModel.ICell CreateCell(Sunshineiot.Utils.NPOI.SS.UserModel.IRow row, int column, String value)
        {
         ...
         */
        public static void SetCellStyleProperty(Sunshineiot.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                Sunshineiot.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (Sunshineiot.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (Sunshineiot.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (Sunshineiot.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (Sunshineiot.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
