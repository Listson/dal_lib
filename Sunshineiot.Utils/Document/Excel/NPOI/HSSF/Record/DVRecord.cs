...
namespace Sunshineiot.Utils.NPOI.HSSF.Record
{
    ...
    public class DVRecord : StandardRecord
    {
        ...
        private Sunshineiot.Utils.NPOI.SS.Formula.Formula _formula1;
        ...
        private Sunshineiot.Utils.NPOI.SS.Formula.Formula _formula2;
            ...
            CellRangeAddressList regions)
        {
            ...
            _formula1 = Sunshineiot.Utils.NPOI.SS.Formula.Formula.Create(formula1);
            _formula2 = Sunshineiot.Utils.NPOI.SS.Formula.Formula.Create(formula2);
            _regions = regions;
        }
        ...
        public DVRecord(RecordInputStream in1)
        {
            ...
            _formula1 = Sunshineiot.Utils.NPOI.SS.Formula.Formula.Read(field_size_first_formula, in1);

            int field_size_sec_formula = in1.ReadUShort();
            _not_used_2 = in1.ReadShort();

            //read sec formula data condition
            _formula2 = Sunshineiot.Utils.NPOI.SS.Formula.Formula.Read(field_size_sec_formula, in1);
