...
namespace Sunshineiot.Utils.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private Sunshineiot.Utils.NPOI.SS.Formula.Formula _formula;
            ...
            : base(in1)
        {
		    ...
		    _formula = Sunshineiot.Utils.NPOI.SS.Formula.Formula.Read(formulaTokenLen, in1, totalFormulaLen);
        }
        public ArrayRecord(Sunshineiot.Utils.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
