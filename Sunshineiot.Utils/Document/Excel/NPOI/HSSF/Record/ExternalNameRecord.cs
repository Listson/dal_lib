...
namespace Sunshineiot.Utils.NPOI.HSSF.Record
{
    ...
    using Sunshineiot.Utils.NPOI.SS.Formula.Constant;
    ...
    public class ExternalNameRecord : StandardRecord
    {
        ...
        private Sunshineiot.Utils.NPOI.SS.Formula.Formula field_5_name_definition; // TODO - junits for name definition field
 ...
 */
        ...
        public ExternalNameRecord(RecordInputStream in1)
        {
            ...
            //nBytesRemaining -= 2;
            //field_5_name_definition = Sunshineiot.Utils.NPOI.SS.Formula.Formula.Read(formulaLen, in1, nBytesRemaining);
        }
