...
namespace Sunshineiot.Utils.NPOI.SS.Formula
{
    ...
    using Sunshineiot.Utils.NPOI.SS.Formula.Functions;
    ...
    class OperationEvaluatorFactory
    {
        ...
        private static void Add(Hashtable m, OperationPtg ptgKey,
            Sunshineiot.Utils.NPOI.SS.Formula.Functions.Function instance)
        {
                ...
                OperationEvaluationContext ec)
        {
            ...
            Sunshineiot.Utils.NPOI.SS.Formula.Functions.Function result = _instancesByPtgClass[ptg] as Sunshineiot.Utils.NPOI.SS.Formula.Functions.Function;
            ...
            if (ptg is AbstractFunctionPtg)
            {
                ...
                {
                    case Sunshineiot.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_INDIRECT:
                        return Indirect.instance.Evaluate(args, ec);
                    case Sunshineiot.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_EXTERNAL:
