...
namespace Sunshineiot.Utils.NPOI.SS.Formula.Eval.Forked
{
     ...
     * 90% of memory consumption is due to loading of the {@link HSSFWorkbook} or {@link Sunshineiot.Utils.NPOI.xssf.usermodel.XSSFWorkbook}.
