...
namespace Sunshineiot.Utils.NPOI.SS.Formula
{
    ...
    public class SheetNameFormatter
    {
        ...
        {
            return Sunshineiot.Utils.NPOI.SS.Util.CellReference.CellReferenceIsWithinRange(lettersPrefix, numbersSuffix, Sunshineiot.Utils.NPOI.SS.SpreadsheetVersion.EXCEL97);
        }
