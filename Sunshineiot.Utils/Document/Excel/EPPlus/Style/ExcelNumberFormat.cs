...
namespace Sunshineiot.Utils.EPPlus.Style
{
    ...
    {
        internal ExcelNumberFormat(ExcelStyles styles, Sunshineiot.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string Address, int index) :
