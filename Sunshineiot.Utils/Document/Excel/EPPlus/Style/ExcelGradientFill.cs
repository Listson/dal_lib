...
namespace Sunshineiot.Utils.EPPlus.Style
{
    ...
    {
        internal ExcelGradientFill(ExcelStyles styles, Sunshineiot.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string address, int index) :
