...
namespace Sunshineiot.Utils.EPPlus.ConditionalFormatting
{
  /// <summary>
  ...
  internal static class ExcelConditionalFormattingConstants
  {
    ...
    internal class Errors
    {
      ...
      internal const string InvalidCfruleObject = @"The supplied item must inherit Sunshineiot.Utils.EPPlus.ConditionalFormatting.ExcelConditionalFormattingRule";
      internal const string InvalidConditionalFormattingObject = @"The supplied item must inherit Sunshineiot.Utils.EPPlus.ConditionalFormatting.ExcelConditionalFormatting";
