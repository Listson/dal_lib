...
using Sunshineiot.Utils.EPPlus.Utils;
using System.Xml;
using Sunshineiot.Utils.EPPlus.DataValidation.Contracts;

namespace Sunshineiot.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit Sunshineiot.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
