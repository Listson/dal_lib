...
namespace Sunshineiot.Core
{
    public class APP
    {
        ...
        //配置自动更新的字段
        public static string FIELD_UPDATE_PERSON = "update_user_id";
        public static string FIELD_UPDATE_DATE = "update_date";
        public static string FIELD_CREATE_PERSON = "create_user_id";
        ...
        //数据库的一些设置
        public static string DB_DEFAULT_CONN_NAME = "conn"; //ConfigurationManager.ConnectionStrings[1].Name;
        ...
        //    string strFilePath = Path.Combine(@"d:\", "DeviceLog");
        //    strFilePath = Path.Combine(@"d:\", "NoReg.txt");
